        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurriculoPdf = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConectadoComId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Conexoes_Usuarios_ConectadoComId",
                        column: x => x.ConectadoComId,
                        principalTable: "Usuarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Conexoes_Usuarios_UsuarioId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CursoId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UsuarioId = table.Column<int>(type: "int", nullable: false),
                    UsuarioIdentityId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DataInscricao = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Concluido = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CursosUsuarios", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PublicacaoCurtidas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PublicacaoCurtidas_Publicacoes_PublicacaoId",
                        column: x => x.PublicacaoId,
                        principalTable: "Publicacoes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PublicacaoCurtidas_Usuarios_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "Usuarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CurtidasComentario", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CurtidasComentario_Comentarios_ComentarioId",
                        column: x => x.ComentarioId,
                        principalTable: "Comentarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CurtidasComentario_Usuarios_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "Usuarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conexoes_ConectadoComId",
                table: "Conexoes",
                column: "ConectadoComId");

            migrationBuilder.CreateIndex(
                name: "IX_Conexoes_UsuarioId",
                table: "Conexoes",
                column: "UsuarioId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CursosUsuarios_UsuarioId_CursoId",
                table: "CursosUsuarios",
                columns: new[] { "UsuarioId", "CursoId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CurtidasComentario_ComentarioId",
                table: "CurtidasComentario",
                column: "ComentarioId");

            migrationBuilder.CreateIndex(
                name: "IX_CurtidasComentario_UsuarioId_ComentarioId",
                table: "CurtidasComentario",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PublicacaoCurtidas_PublicacaoId",
                table: "PublicacaoCurtidas",
                column: "PublicacaoId");

            migrationBuilder.CreateIndex(
                name: "IX_PublicacaoCurtidas_UsuarioId",
                table: "PublicacaoCurtidas",
                column: "UsuarioId");
